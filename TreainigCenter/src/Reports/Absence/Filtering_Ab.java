 ...
 * @author David Sherif
 */
public class Filtering_Ab extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(g, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        showREPORT(REPORTSPATH+"\\Reports\\Absence\\Absence.jasper", 
        new Object[]{"Coursename",c.getSelectedItem(),
            "Groupid",g.getSelectedItem(),
            "Lec",l.getSelectedItem(),
            "Datek",OracleConn.ret_value("select to_char(attendance.months,'DD/MON/YYYY') from attendance where LECNUMBER="+l.getSelectedItem()+" AND groupid=(select tableid from groups where courseid=(select courseid from courses where coursename='"+c.getSelectedItem()+"')AND tableid=ATTENDANCE.GROUPID)")});
